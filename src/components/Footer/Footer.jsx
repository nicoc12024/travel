        ...
        <div className="footerCard flex">
          <div className="footerIntro flex">
            ...
            <div data-aos="fade-up" data-aos-duration="2000" className="footerParagraph">
              ...
              eos fuga hic cum voluptatem minima, tempore non odio provident nobis ipsam
              at, doloremque sed cupiditate ipsum in, atque soluta?
            </div>
          ...
          <div className="footerDiv">
            <small>COPYRIGHTS RESERVED - NICOLAS CABELLO 2022</small>
          </div>
        </div>
      </div>
    </section>
